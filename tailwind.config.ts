...
const variantPlugin: PluginCreator = ({ addVariant }) => {
  ...
  addVariant(
    "cover_list_half_max_col_count_1",
    ".cover_list_half_max_col_count_1 &"
  );
  addVariant(
    "cover_list_half_max_col_count_2",
    ".cover_list_half_max_col_count_2 &"
  );
  addVariant(
    "cover_list_half_max_col_count_3",
    ".cover_list_half_max_col_count_3 &"
  );
  addVariant(
    "cover_list_half_max_col_count_4",
    ".cover_list_half_max_col_count_4 &"
  );
  ...
  addVariant("post_index_item_summary_on_off_flag_on", [
    ".post_index_item_summary_on_off_flag_on &",
    ".post_index_item_summary_on_off_flag_on&",
  ]);
  addVariant("post_index_item_summary_on_off_flag_off", [
    ".post_index_item_summary_on_off_flag_off &",
    ".post_index_item_summary_on_off_flag_off&",
  ]);
  addVariant("post_index_item_tag_on_off_flag_on", [
    ".post_index_item_tag_on_off_flag_on &",
    ".post_index_item_tag_on_off_flag_on&",
  ]);
  addVariant("post_index_item_tag_on_off_flag_off", [
...
export default {
  darkMode: "class",
  content: ["./src/**/*.tsx", "./src/**/*.scss", "./src/**/*.ts"],
  theme: {
    extend: {
      width: {
