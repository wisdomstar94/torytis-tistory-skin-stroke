    ...
    <>
      ...
      >
        ...
        <s_ad_div>
          ...
          >
            <span className="inline-flex flex-wrap whitespace-pre-line break-all text-slate-400 dark:text-white/70 dark-c:text-white/70">
        ...
        />
        <div className={classes("comment-row", "block relative m-0 p-0")}>
          <div
            className={classes("block m-0 mb-7 p-0 relative text-xl font-bold")}
          >
            댓글
          ...
          <s_rp>
            <s_rp_container>
              <ol className={classes("comment-list", "block m-0 p-0 relative")}>
                <s_rp_rep>
                  <li
                    id="[##_rp_rep_id_##]"
                    className={classes("list-none m-0 p-0 relative block")}
                  >
                    <div
                      className={classes(
                    ...
                    >
                      ...
                      >
                        <div className="comment-desc whitespace-pre-wrap break-all">
                          [##_rp_rep_desc_##]
                        </div>
                        {/* <CallJavascript 
                          code="removeHTMLTag({ className: 'comment-desc', isExecute: true })"
                          /> */}
                        <div className={classes("block mt-1 relative")}>
                          <a
                            href="#"
                    ...
                    <s_rp2_container>
                      <ol className={classes("block m-0 p-0 relative")}>
                        <s_rp2_rep>
                          <li
                            id="[##_rp_rep_id_##]"
                            className={classes(
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                <div className={classes("w-full flex-1")}>
                                  <div
                                    className={classes(
            ...
            <s_rp_input_form>
              ...
              >
                <s_rp_guest>
                  ...
                  >
                    <div
                      className={classes("w-full block text-sm mb-1 relative")}
                    >
                  ...
                  >
                    <div
                      className={classes("w-full block text-sm mb-1 relative")}
                    >
                      <label htmlFor="[##_rp_input_password_##]">
                        비밀번호
                      </label>
                    </div>
                    <div className={classes("w-full block text-xs relative")}>
