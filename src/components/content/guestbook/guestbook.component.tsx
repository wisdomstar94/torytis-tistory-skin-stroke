        ...
        <s_guest>
          <s_guest_container>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={classes("w-full block relative", "flex-1")}
                        >
                          <div
                            className={classes(
                              "rep-name-area",
            ...
            {/* <CallJavascript 
              ...
              /> */}
            <CallJavascript code="convertCommentDesc()" />
          </s_guest_container>
          <s_guest_input_form>
            <ul
              className={classes(
            ...
            >
              <s_guest_form>
                ...
                >
                  ...
                  <div className={classes("w-full block text-xs relative")}>
                    <input
                      type="text"
                      className={classes(
                        "w-full inline-block border bg-transparent border-black rounded-none px-2 py-1.5 text-xs box-border h-[30px]"
                      )}
                ...
                >
                  <div className={classes("w-full block text-sm mb-1")}>
                    <label htmlFor="[##_guest_input_password_##]">
                      비밀번호
                    </label>
                  </div>
                  <div className={classes("w-full block text-xs relative")}>
